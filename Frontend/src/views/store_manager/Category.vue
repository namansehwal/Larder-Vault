          ...
          <div>
            ...
            <div class="row">
              <div class="col-lg-3 col-md-4 col-sm-6" v-for="(category, index) in categories" :key="index">
                <div class="card m-1">
                  <img :src="`${category.image}`" class="card-img-top" alt="..." style="height: 200px" />
                  <div class="card-body">
                    <h5 class="card-title">{{ category.name }}</h5>
                    <button class="btn btn-outline-secondary btn-sm m-1" @click="openEditModal(category)"
                      data-bs-toggle="modal" data-bs-target="#editModal">
                      Edit Name
                    </button>
                    <button class="btn btn-outline-danger btn-sm m-1" @click="deleteCategory(category.id)">
                      Delete
                    </button>
                  </div>
                </div>
          ...
          <div class="modal-body">
            ...
            <form @submit.prevent="submitEditForm">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="editCategoryName" v-model="editedCategoryName" required />
              </div>
